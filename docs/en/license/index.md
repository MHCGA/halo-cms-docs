...
- Build scripts, theme extensions, and automation tooling are published under the [MIT License](https://opensource.org/licenses/MIT).
...
## Content (CC BY-SA 4.0 + SATA) {#content-license}

Unless otherwise stated, articles, diagrams, and supporting text are released under:

1. [Creative Commons BY-SA 4.0 International](https://creativecommons.org/licenses/by-sa/4.0/)
2. The additional [Star And Thank Author (SATA) License](https://github.com/zTrix/sata-license)
...
Need a different arrangement? Open an issue or PR so we can discuss a solution that respects contributor rights while meeting your use case.
